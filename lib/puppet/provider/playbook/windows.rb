...
# https://docs.puppet.com/puppet/latest/type.html#exec-provider-windows
Puppet::Type.type(:playbook).provide(
  :windows,
  :parent => Puppet::Type.type(:exec).provider(:windows),
) do

  @doc = 'Default provider under MS Windows, inherited from exec.'
